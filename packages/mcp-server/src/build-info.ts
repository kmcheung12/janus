/**
 * The build this daemon came from.
 *
...
export function buildLine(name: string): string {
  try {
    ...
    // Running from source, or a build that predates the stamp. Saying so is
    // more useful than throwing, and more honest than claiming a version.
